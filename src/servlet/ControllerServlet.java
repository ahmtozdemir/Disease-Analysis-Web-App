...
public class ControllerServlet extends HttpServlet {
    ...
    private List<String> birliktelikGetir(String hastalik) throws IOException {
        ...
        for(Integer i:sayilar) {
            String line = Files.readAllLines(Paths.get("C:\\Users\\Ahmet\\Intellij Projects\\Disease-Analysis\\web\\data\\AssociationRules.txt")).get(i-1);
    ...
    public static List<Integer> lineNumbers(String x) throws IOException {
        LineNumberReader lineReader = new LineNumberReader(new FileReader("C:\\Users\\Ahmet\\Intellij Projects\\Disease-Analysis\\web\\data\\AssociationRules.txt"));
        List<Integer>sayilar=new ArrayList<>();
        String line;
